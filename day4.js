...
//         console.log(key);
//     }
// Q.29.Explain Local Scope, Block Scope, Functional Scope and Scope Chain in javascript.
...
//     })
//     console.log(res);
// Q.33.Explain passed by value and passed by reference.
...
//     console.log(a);//4
//     console.log(b);//2
// Q.34.Please explain Self Invoking Function and its code.
// -self invoking functions(IIFE) are kind of an anonymous function which gets invoked automatically after its declaration.we dont have to manually invoke it.
// -example-
//     (function(message){
//         console.log('message');
//     })('morning');
